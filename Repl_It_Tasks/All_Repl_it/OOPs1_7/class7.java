...
class Catalog {
	...
	public void loadPrices() {
		...
		prices.addAll(
				Arrays.asList(449.0, 549.0, 1149.0, 1499.99, 39.99, 349.99, 79.99, 39.99, 429.0, 399.0, 2199.0, 559.0));

		/*
		 * 449.0, 549.0, 1149.0, 1499.99, 39.99, 349.99, 79.99, 39.99, 429.0, 399.0,
		 * 2199.0, 559.0
		 */
	}
	...
	public void loadMonthlyPayments() {
		...
		monthlyPayments
				.addAll(Arrays.asList(18.71, 22.88, 56.16, 79.49, 2.68, 15.12, 8.98, 4.56, 18.31, 16.25, 89.49, 21.18));

		/*
		 * 18.71, 22.88, 56.16, 79.49, 2.68, 15.12, 8.98, 4.56, 18.31, 16.25, 89.49,
		 * 21.18
		 */
	}
	...
	public StringBuilder getWholeCatalog() {
		...
		for (int i = 0; i < prices.size(); i++) {
			mystrs += "" + items.get(i) + "-" + prices.get(i) + "-" + monthlyPayments.get(i) + "\n";
		}
		return new StringBuilder(mystrs);
	}
	...
	public String getItemDetails(String item) {
		...
		for (int i = 0; i < prices.size(); i++) {
			if (items.get(i).equals(item)) {
				return str = str + items.get(i) + "-" + prices.get(i) + "-" + monthlyPayments.get(i);
			}
		}
		return null;
	}
