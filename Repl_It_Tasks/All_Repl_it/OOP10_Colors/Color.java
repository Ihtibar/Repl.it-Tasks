...
public class Color {
    ...
    public String toString() {
        ...
        return Arrays.equals(WHITE,rgb)?"white":Arrays.equals(LIGHT_GRAY,rgb)?"light gray":Arrays.equals(GRAY,rgb)?"gray":Arrays.equals(DARK_GRAY,rgb)?"dark gray":Arrays.equals(BLACK,rgb)?"black":
        Arrays.equals(RED,rgb)?"red":Arrays.equals(PINK,rgb)?"pink": 
        Arrays.equals(ORANGE,rgb)?"orange":Arrays.equals(YELLOW,rgb)?"yellow":Arrays.equals(GREEN,rgb)?"green":Arrays.equals(MAGENTA,rgb)?"magenta":Arrays.equals(CYAN,rgb)?"cyan":Arrays.equals(BLUE,rgb)?"blue":"n/a";
    }
