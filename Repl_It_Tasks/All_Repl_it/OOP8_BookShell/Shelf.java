...
public class Shelf {
    ...
    public static boolean isIDUnique(int id){
     for(int a=0; a<theBooks.size();a++) 
    	 if(theBooks.get(a).getId()==id) 
    		     return false;
    ...
    public static void removeBook(int id) {
       ...
       for(int a=0;a<theBooks.size();a++) 
    	    	  if(theBooks.get(a).getId()==id) 
    	    	     theBooks.remove(theBooks.get(a));
    ...
    for(int a=0;a<theBooks.size();a++) 
	    	if(theBooks.get(a).getAuthor().toLowerCase().equals(author.toLowerCase())) {
	    		   theBooks.remove(theBooks.get(a));
	    		        a--;
	        	}
    }
